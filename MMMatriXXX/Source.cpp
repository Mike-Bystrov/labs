//--------------------------------------------------------------
// 1. emplace_back дл€ контейнера типа vector
// 2. список инициализации (initializer_list)
//--------------------------------------------------------------
#include <new>     // Ќеобходим дл€ использовани€ placement new
#include <iostream>
#include <stack>
...
public:
    ...
    ~KStack()
    {
        ...
        //delete[] pVec;    - приводит к зацикливанию
    }
